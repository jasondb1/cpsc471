...
$start_directory = $_GET['starting_directory'];
$mobile_start = $_GET['mobile'];
/* 
 * GENERAL SETTINGS
 */
...
//
$_CONFIG['main_title'] = "JDS File Browser";
...
//
$_CONFIG['hidden_files'] = array(".ftpquota", "index.php", "index.php~", ".htaccess", ".htpasswd" , "explorer.php" , "index.htm",".filelog.txt");
...
// Default: $_CONFIG['users'] = array(array("admin", "zx12#21V", "admin"));
//
//$_CONFIG['users'] = array(array("admin", "zx12#21V", "admin"));

//get employee data
	//include_once ("cfg_variables.php");
	$dbhost = "sql5c0a.megasqlservers.com";	// Change this to the proper DB Host name
$dbusername = "jdsservice149125"; 	// Change this to the proper DB User
$dbpass = "zx12#21V";	// Change this to the proper DB User password
$dbname	= "jdsdata_jdsservices_ca"; 	// Change this to the proper DB Name
	...
	//open database
		...
		$sql = "SELECT * FROM authuser WHERE status = 'Active'" ;
		$retval = mysql_query($sql) or die(mysql_error());	

		while($row=mysql_fetch_array($retval))
		{
			$my_array[]=array($row['uname'],$row['passwd'],"admin");
		}
		

$_CONFIG['users']=$my_array;
...
//
$_CONFIG['upload_reject_extension'] = array("php","js");
...
//
$_CONFIG['upload_email'] = "jasond@jdsservices.ca";
...
$_CONFIG['starting_dir'] = ".";
//$_CONFIG['starting_dir'] = "./files/projects/$starting_directory/";
...
//
$_CONFIG['basedir'] = "";
//$_CONFIG['basedir'] = "./files/projects/";
