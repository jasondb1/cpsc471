...
///////////////////////////////////////////////////////////////////////////////*/	
	//get and set initial variables
		...
		$page_title="View Quotes";									//***
		
		$dbtable		= $db_table_quote;						//***
...
/////////////////////////////////////////////////*/
	...
	$columns = array(                     
		array('columnName'=>'CustomerID', 		'displayName'=>'Customer', 			'type'=>'text'),
		array('columnName'=>'QuoteNo', 			'displayName'=>'Quote #', 		'type'=>'text'),
		array('columnName'=>'date_created', 	'displayName'=>'Order Date', 	'type'=>'text'),
	...
	$table->editPage="employee_quote_entry.php";		//***
				...
				<section class="is-page-content">
					<div class="row flush" style="padding:0em; padding-top:2em;">
						<div class="12u">
							...
							<div id="menu">
								<ul>
								<li><a href="employee_quote_entry.php" ><span class="button-menu"><i class="fa fa-plus fa-fw"></i>&nbsp; New Quote</span></a></li>
								</ul>
							</div>
							<hr>
						</div>
