...
///////////////////////////////////////////////////////////////////////////////*/
	...
	$path=$si_path;
	$db_table="site_instructions";
	
	//Edit or upload page
	$edit_page="upload_site_instruction.php";	
	
	//Sets the columns visible in the table format (column name=>display name)
	$columns=array("edit"=>"","si_date"=>"Date","si_number"=>"SI Number","description"=>"Description","notes"=>"Notes","status"=>"Status","filename"=>"","del"=>"");
...
<div class="wrap">
	...
	<div id="main">
		<!-- //Main Area -->
		<div class="full_w">
				<div class="h_title">Site Instructions</div>
				<h2>Site Instructions :: Jobnumber - <?php echo $jobnumber;?></h2>
				<input type="button" name="action" class="button add" value="Add Site Instruction" onclick="window.location.href='<?php echo $edit_page . "?j=" . $masked_jobnumber;?>'"> <br> 
