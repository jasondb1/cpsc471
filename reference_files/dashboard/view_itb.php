...
///////////////////////////////////////////////////////////////////////////////*/
	...
	//Edit or upload page
	$edit_page="upload_itb.php";	
	
	//Sets the columns visible in the table format (column name=>display name)
	$columns=array("edit"=>"","date_entered"=>"Date","date_closing"=>"Closing","vendor"=>"Vendor","division"=>"Division","description"=>"Description","notes"=>"Notes","status"=>"Status","filename"=>"","del"=>"");
...
<div class="wrap">
	...
	<div id="main">
		...
		<div class="full_w">
				...
				<h2>Invitation to Bid :: Jobnumber - <?php echo $jobnumber;?></h2>
				<input type="button" name="action" value="Add ITB" class="button add" onclick="window.location.href='<?php echo $edit_page . "?j=". $masked_jobnumber;?>'"> <br> 
