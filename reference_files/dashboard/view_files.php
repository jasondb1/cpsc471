<?php
/////******** Add contractor/Vendor Section where vendor can only view his section
...
<div class="wrap">
	...
	<div id="main">
		<!-- //Main Area -->
		<div class="full_w">
				<div class="h_title">File Viewer</div>
				<h2>Files :: Jobnumber - <?php echo $jobnumber;?></h2>
				<input type="button" name="action" class="button add" value="Add File" onclick="window.location.href='<?php echo $edit_page . "?j=" . $masked_jobnumber;?>'"> <br> 
