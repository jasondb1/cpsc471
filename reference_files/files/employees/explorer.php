...
//
$_CONFIG['hidden_files'] = array(".ftpquota", "index.php", "index.php~", ".htaccess", ".htpasswd" , "explorer.php" , "index.htm");
...
include ('../../cfg_variables.php');
	...
	//open database
		...
		$sql = "SELECT uname,passwd FROM $db_employee WHERE status='active' AND team<>'Contractor'";
...
// $file_handle = fopen($employee_data_file, 'r');
// $headings = fgetcsv($file_handle);
// $index=0;
// while (($data = fgetcsv($file_handle, 1000, ",")) !== FALSE) {
		// $my_array[] = array ($data[0],$data[1],"admin");
// }
// fclose($file_handle);
