		...
		foreach ($company_databases as $key=>$value){	
			...
			while($row = $result->fetch_assoc()){
			  ...
			  $require_subdivision = $row['require_subdiv'];
				$table .= "<a href=\"employee_workorder_entry.php?edit_record=$jobnumber\" ><b>$jobnumber</b>: $location - $description</a><br><hr>";
			}	//end while
			$table .= "<br><hr>";
		}
?>
					...
					<div class="row">
						...
						<section class="is-page-content">
							...
							<div class="row flush" style="padding:0em; padding-top:2em;">
								<div class="12u">
									<header>
										<h3>Workorder - Select Job</h3>
									</header>
									<div id="menu">
										<ul>
										<li><a href="employee_job_view.php" ><span class="button-menu"><i class="fa fa-arrow-circle-o-left fa-fw"></i>&nbsp; View Database</span></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="row flush" style="padding:0em;">					
								<div class="12u">
									<hr>
									<span class="hangingHead">Workorder</span><br>
