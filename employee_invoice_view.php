					...
					<div class="row flush" style="padding:0em;">
						...
						<!--<div id="opts" style="display:none; font-size: 70%;">-->
							<form method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>" name="viewoptions">
								...
								<input name="filter[]" type="checkbox" value="Approved" /> Approved
								<input name="filter[]" type="checkbox" value="Rejected" /> Rejected
								<input name="filter[]" type="checkbox" value="Received" checked="checked" /> Received
								...
								<?php  
									echo '<br><input class="text" type="text" name="search" placeholder="Search" value="'.$search. '">';
