...
///////////////////////////////////////////////////////////////////////////////*/	
	//get and set initial variables
		...
		$dbtable		= $db_table_sales_order;						//*** In _config.php
...
/////////////////////////////////////////////////*/
	...
	$columns = array(
		array('columnName'=>'SalesOrderNo', 				'displayName'=>'Order No', 			'type'=>'text'),
		array('columnName'=>'QuoteNo',			'displayName'=>'Quote', 				'type'=>'text'),
		array('columnName'=>'status',			'displayName'=>'Status', 				'type'=>'text'),
		array('columnName'=>'Shname',			'displayName'=>'Shipper', 				'type'=>'text'),
		array('columnName'=>'date_received',			'displayName'=>'Recvd', 				'type'=>'date'),
		array('columnName'=>'amount',			'displayName'=>'Amt', 				'type'=>'amount'),
		array('columnName'=>'freight_charge',			'displayName'=>'Freight', 				'type'=>'amount'),
		array('columnName'=>'est_ship_date',			'displayName'=>'Ship Date', 				'type'=>'text'),
		array('columnName'=>'tracking_no',			'displayName'=>'Track #', 				'type'=>'text')							
	);
	...
	if ($orderBy == ''){ $orderBy = "SalesOrderNo";}
	
	//TODO:
	$sql = "SELECT Sales_Order.*, Shipper.Shname FROM Sales_Order JOIN Shipper ON Shipper.ShipperID = Sales_Order.Shipper_Id WHERE " . $where .	" ORDER BY " . $orderBy . " " .$direction;
	...
	$table->editPage="employee_sales_order_entry.php";			//***
				...
				<section class="is-page-content">
					<div class="row flush" style="padding:0em; padding-top:2em;">
						<div class="12u">
							...
							<div id="menu">
								<ul>
								<li><a href="employee_sales_order_entry.php" ><span class="button-menu"><i class="fa fa-plus fa-fw"></i>&nbsp; Add Order</span></a></li>
								</ul>
							</div>
							<hr>
						</div>
