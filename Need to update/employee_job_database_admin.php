...
$headings = array("jobnumber"=>"Job No.","description"=>"Description","location"=>"Location","customer"=>"Customer","bill_to"=>"Bill To","supervisor"=>"Supervisor","status"=>"Status","start_date"=>"Start Date","end_date"=>"End Date","quote_number"=>"Quote","po_number"=>"PO No","notes"=>"Notes","invoice_number"=>"Invoice","contact_name"=>"Contact","contact_number"=>"Number","opened_by"=>"Opened By","date_invoiced"=>"Date Invoiced","date_closed"=>"Date Closed");
