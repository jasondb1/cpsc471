...
<form style="background-color: rgb(204, 204, 204);" method="get" action="<?php $_SERVER['PHP_SELF'] ?>" name="options">
...
//display jobs and linke to time entry sheet	  
	  ...
	  $location = $row['location'];
		echo "<a href=\"employee_po_entry.php?jobnumber=$jobnumber\" ><b>$jobnumber</b>: $location - $description</a><br><hr>";
		}	//end while
