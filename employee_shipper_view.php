...
///////////////////////////////////////////////////////////////////////////////*/	
	//get and set initial variables
		...
		$dbtable		= $db_table_shipper;					//*** In _config.php
...
/////////////////////////////////////////////////*/
	...
	$columns = array(
		array('columnName'=>'ShipperID', 				'displayName'=>'Shipper ID', 			'type'=>'text'),
		array('columnName'=>'Shname',			'displayName'=>'Vendor Name', 				'type'=>'text'),
		array('columnName'=>'Ship_contact_rep',	'displayName'=>'Contact', 				'type'=>'text'),
		array('columnName'=>'Shphone',			'displayName'=>'Phone', 				'type'=>'text'),
		array('columnName'=>'Shemail',			'displayName'=>'Email', 				'type'=>'text')
	);
	...
	$table->editPage="employee_shipper_entry.php";			//***
				...
				<section class="is-page-content">
					<div class="row flush" style="padding:0em; padding-top:2em;">
						<div class="12u">
							...
							<div id="menu">
								<ul>
								<li><a href="employee_shipper_entry.php" ><span class="button-menu"><i class="fa fa-plus fa-fw"></i>&nbsp; Add Shipper</span></a></li>
								</ul>
							</div>
							<hr>
						</div>
