...
///////////////////////////////////////////////////////////////////////////////*/	
	//get and set initial variables
		...
		$dbtable		= $db_table_vendor;						//*** In _config.php
...
/////////////////////////////////////////////////*/
	...
	$columns = array(
		array('columnName'=>'Vendor_ID', 				'displayName'=>'Vendor ID', 			'type'=>'text'),
		array('columnName'=>'Name',			'displayName'=>'Name', 				'type'=>'text'),
		array('columnName'=>'City',			'displayName'=>'City', 				'type'=>'text'),
		array('columnName'=>'Contact',			'displayName'=>'Contact Name', 				'type'=>'text'),
	...
	$table->editPage="employee_vendor_entry.php";			//***
				...
				<section class="is-page-content">
					<div class="row flush" style="padding:0em; padding-top:2em;">
						<div class="12u">
							...
							<div id="menu">
								<ul>
								<li><a href="employee_vendor_entry.php" ><span class="button-menu"><i class="fa fa-plus fa-fw"></i>&nbsp; Add Vendor</span></a></li>
								</ul>
							</div>
							<hr>
						</div>
