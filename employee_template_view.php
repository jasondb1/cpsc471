...
///////////////////////////////////////////////////////////////////////////////*/	
	//get and set initial variables
		...
		$dbtable		= $db_table_temp;						//*** In _config.php
...
/////////////////////////////////////////////////*/
	...
	$table->editPage="employee_template_entry.php";			//***
				...
				<section class="is-page-content">
					<div class="row flush" style="padding:0em; padding-top:2em;">
						<div class="12u">
							...
							<div id="menu">
								<ul>
								<li><a href="employee_template_entry.php" ><span class="button-menu"><i class="fa fa-plus fa-fw"></i>&nbsp; Add Template Item</span></a></li>
								</ul>
							</div>
							<hr>
						</div>
