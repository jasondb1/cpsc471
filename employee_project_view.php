...
///////////////////////////////////////////////////////////////////////////////*/	
	//get and set initial variables
		...
		$dbtable		= $db_table_project;						//*** In _config.php
...
/////////////////////////////////////////////////*/
	...
	$columns = array(
		array('columnName'=>'ProjectNo', 			'displayName'=>'Project Number', 			'type'=>'text'),
		array('columnName'=>'Description',			'displayName'=>'Description', 				'type'=>'text'),
		array('columnName'=>'Status',				'displayName'=>'Status', 				'type'=>'text'),
		array('columnName'=>'StartDate',			'displayName'=>'Start Date', 				'type'=>'text'),
		array('columnName'=>'EndDate',				'displayName'=>'End Date', 				'type'=>'text'),
		array('columnName'=>'notes',				'displayName'=>'Notes', 				'type'=>'text')
	);
	...
	if ($search != ""){
		...
		$where =" Status <> 'Complete'"; //default criteria
	}
	...
	$table->editPage="employee_project_entry.php";			//***
				...
				<section class="is-page-content">
					<div class="row flush" style="padding:0em; padding-top:2em;">
						<div class="12u">
							...
							<div id="menu">
								<ul>
								<li><a href="employee_project_entry.php" ><span class="button-menu"><i class="fa fa-plus fa-fw"></i>&nbsp; Add Project</span></a></li>
								</ul>
							</div>
							<hr>
						</div>
