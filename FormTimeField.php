...
//
    ...
    public function toHtml(){
        ...
        $html .= '<input id="timepicker'. $rand  .'" class="text" size="'. $this->size .
        ...
        $html .= '<script>';
        $html .= '$(function() {';
        $html .= '$( "#timepicker'. $rand .'" ).timepicker(';
        $html .= '	{';
        $html .= 'controlType: "select",';
        $html .= 'timeFormat: "hh:mm tt",';
		$html .= 'steoHour: 1,';
        $html .= 'stepMinute: 15,';
        $html .= '}';
        $html .= ');';
        ...
        $html .= '#timepicker'. $rand .'{';
        $html .= 'background-position:right center;';
        $html .= 'background-repeat:no-repeat; }';
        $html .= '#timepicker'. $rand .'{background-image:url("images/clock.png");';
		$html .= '</style>';
