...
///////////////////////////////////////////////////////////////////////////////*/
	...
	//Edit or upload page
	$edit_page="../upload_rfi.php";	
	
	//Sets the columns visible in the table format (column name=>display name) special ("edit,"amount","price","del","delete","filename")
	$columns=array("edit"=>"","rfi_number"=>"RFI Number","date"=>"Date Entered","description"=>"Description","concern"=>"Concern","rfi_from"=>"From","rfi_to"=>"To","status"=>"Status","del"=>"");
